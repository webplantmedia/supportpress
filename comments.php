...
<div id="respond">
	...
	<?php else : //No registration required ?>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" class="comment-post" id="commentform">
		
		<h3><?php comment_form_title( __('Reply to this post', 'woothemes'), __('Leave a Reply to %s', 'woothemes') ); ?></h3>
		...
		<?php else : //If user is not logged in ?>
			...
			<p>
				...
				<input type="text" name="author" class="txt input-text" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" />
				
			</p>

			<p>
				<label for="email"><?php _e('Mail (will not be published)', 'woothemes') ?> <?php if ($req) ?> (<?php _e('Required', 'woothemes'); ?>) <?php ; ?></label>
				<input type="text" name="email" class="txt input-text" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" />
				
			</p>

			<p>
				<label for="url"><?php _e('Website', 'woothemes') ?></label>
				<input type="text" name="url" class="txt input-text" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
		...
		<p>
		<label for="comment"><?php _e('Add a comment') ?></label>
		<textarea name="comment" id="comment" rows="10" cols="50" tabindex="4" class="input-text"></textarea></p>

		<p><input name="submit" type="submit" id="submit" class="button" tabindex="5" value="<?php _e('Submit Comment', 'woothemes') ?>" />
